...
A later milestone can add integration with `Postiz <https://github.com/gitroomhq/postiz-app>`_ or similar social media publishing systems.
...
- `Eventyay Social Media <https://github.com/fossasia/eventyay-socialmedia>`_
- `Postiz <https://github.com/gitroomhq/postiz-app>`_
